...
public class LonePairs : MonoBehaviour
{
    ...
    public void CalculateForceVector() {
        ...
        int numVectors = 0;
        foreach(Tuple<GameObject, GameObject> neighbor in parent.GetNeighbors()) { // loops through all elements bonded to parent element
            GameObject element = neighbor.Item2;
